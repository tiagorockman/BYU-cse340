...
- CSS and HTML --> Web Developer Extension
- https://wave.webaim.org --> Contract and other validations
...
## Generate ramdom 64 string
terminal --> node
terminal run --> require('crypto').randomBytes(64).toString('hex')